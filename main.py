...
import google_drive_v3_handler as v3_handler
...
def main():
    ...
    try:
        ...
        v3_handler.simple_test(service)
        v3_handler.image_create(service, file_name="profile.png")
        v3_handler.audio_create(service, file_name="sample.mp3")
